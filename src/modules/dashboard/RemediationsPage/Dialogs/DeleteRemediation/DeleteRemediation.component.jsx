...
import styles from './DeleteRemediation.module.scss';
...
export default function DeleteRemediation({ open, onClose, remediationId: remediationId, onDeleteSuccess }) {
  ...
  return (
    <Dialog
      ...
      title={(
        <>
          <Typography variant='body1' component='span'>You are about to delete the remediation</Typography>
          <Typography variant='body2' component='span'>Are you sure you want to delete this remediation?</Typography>
        </>
      )}
      titleIcon={(
